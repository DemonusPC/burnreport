...
// TODO: There should just be one type
export const searchSuggestionToProductEntity = (
  searchEntity: SearchEntity
): ProductEntity => {
  if (searchEntity === SearchEntity.Spi) {
    return ProductEntity.Spi;
  }
...
const ProductSearchForm = ({
  initialText,
  getSuggestions = getProductSearchSuggestions,
  getSubmitUrl = productDefault,
  ...
  React.useEffect(() => {
    ...
    getSuggestions(escapedText)
      .then((json: SearchSuggestion[]) => {
